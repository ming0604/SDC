...
def video(plots_folder, video_folder,fps):
    video_path = video_folder + 'moving.mp4'
...
def main():
    lidar_folder = './result_moving/lidar/'
    image_folder = './result_moving/camera/'
    plot_output_folder = './projection_plot/moving'
    video_folder = './video/'
